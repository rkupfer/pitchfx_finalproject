...
from .models import Input, PITCHER_RACE, PITCHER_ETHNICITY, PARK_NAME, HOME_OR_AWAY
# Park_Name, Pitcher_Ethnicity
...
class InputForm(forms.ModelForm):
    ...
    class Meta:
        model = Input
        fields = ['pitcher_race', 'pitcher_ethnicity', 'park_name', 'home_or_away']
